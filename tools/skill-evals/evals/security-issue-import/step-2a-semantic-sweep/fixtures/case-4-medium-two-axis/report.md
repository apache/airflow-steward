...
By registering a DAG with a crafted callback URL (e.g. http://169.254.169.254/
for AWS metadata), an authenticated DAG author can trigger outbound requests
to internal or cloud-metadata endpoints.
