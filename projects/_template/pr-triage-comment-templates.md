...
- [TODO: `<Project Name>` — pr-triage comment templates](#todo-project-name--pr-triage-comment-templates)
...
framework's [`comment-templates.md`](../../.claude/skills/pr-triage/comment-templates.md)
...
[`comment-templates.md`](../../.claude/skills/pr-triage/comment-templates.md)
...
the skill posts, and the `pr-stats` skill uses the same marker for
...
(see [`comment-templates.md`](../../.claude/skills/pr-triage/comment-templates.md#ai-attribution-footer)
...
The framework's [`comment-templates.md`](../../.claude/skills/pr-triage/comment-templates.md)
